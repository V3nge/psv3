...
(window.webpackJsonp = window.webpackJsonp || []).push([[54], {
    0: function (e, t, n) {
        ...
        var r = n(20), o = n(10), c = n(33), l = n(18),
            f = (n(60), n(15), n(45), n(219), n(30), n(110), n(47), n(50), n(40), n(41), n(63), n(32), n(83), n(149), n(163), n(214), n(113), n(146), n(211), n(62), n(65), n(1)),
            h = n(14);
            ...
            return function (e, t) {
                ...
                return function (t, r) {
                    for (var path = "", data = t || {}, o = (r || {}).pretty ? K : encodeURIComponent, c = 0; c < e.length; c++) {
                        var l = e[c];
                        if ("string" != typeof l) {
                            var f = data[l.name || "pathMatch"], h = void 0;
                            if (null == f) {
                                if (l.optional) {
                            ...
                            if (Array.isArray(f)) {
                                ...
                                if (h = l.asterisk ? X(f) : o(f), !n[c].test(h)) throw new TypeError('Expected "' + l.name + '" to match "' + l.pattern + '", but received "' + h + '"');
                                path += l.prefix + h
                            }
                        } else path += l
                    }
                ...
                for (; null != (n = F.exec(e));) {
                    ...
                    if (path += e.slice(c, d), c = d + f.length, h) path += h[1]; else {
                        var m = e[c], v = n[2], y = n[3], x = n[4], w = n[5], O = n[6], _ = n[7];
                        path && (r.push(path), path = "");
                        var j = null != v && null != m && m !== v, $ = "+" === O || "*" === O,
                            P = "?" === O || "*" === O, k = n[2] || l, pattern = x || w;
                        r.push({
                            name: y || o++,
                            prefix: v || "",
                            delimiter: k,
        ...
        "use strict";
        n(46), n(15), n(34), n(47), n(45), n(62), n(65), n(63), n(30), n(69), n(40), n(32), n(43), n(71), n(72), n(41);
        var r = n(1);
        ...
        function r(e, t) {
            for (var n = [], r = {}, i = 0; i < t.length; i++) {
                var o = t[i], c = o[0], l = {id: e + ":" + i, css: o[1], media: o[2], sourceMap: o[3]};
        ...
        var c = {}, head = o && (document.head || document.getElementsByTagName("head")[0]), l = null, f = 0, h = !1,
            d = function () {
        ...
        function P(e, t, n, r) {
            var o = n ? "" : r.css;
            if (e.styleSheet) e.styleSheet.cssText = $(t, o); else {
                var c = document.createTextNode(o), l = e.childNodes;
        ...
        var r = {
            ...
            render: function (e, t) {
                var n = t.parent, r = t.slots, o = t.props, c = r(), l = c.default;
                void 0 === l && (l = []);
                var f = c.placeholder;
                return n._isMounted ? l : (n.$once("hook:mounted", (function () {
                    n.$forceUpdate()
                })), o.placeholderTag && (o.placeholder || f) ? e(o.placeholderTag, {class: ["client-only-placeholder"]}, o.placeholder || f) : l.length > 0 ? l.map((function () {
                    return e(!1)
                })) : e(!1))
            }
        };
        ...
        (0, n(108).default)("1a73ea6b", content, !0, {sourceMap: !1})
    }, 192: function (e, t, n) {
        "use strict";
        t.a = function (e, t) {
        ...
        function w() {
            var path = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                base = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "", e = path.split("/"),
                t = base.split("/");
        ...
        var O, _ = {}, j = function () {
            ...
            var r = $(), o = r.config, c = r.includes;
            P.apply(void 0, ["config", o.id].concat(t)), Array.isArray(c) && c.forEach((function (e) {
                P.apply(void 0, ["config", e.id].concat(t))
            }))
        }, T = function (e, t) {
            v() && (window["ga-disable-".concat(e)] = t)
        }, R = function () {
            var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0], t = $(), n = t.config,
                r = t.includes;
            T(n.id, e), Array.isArray(r) && r.forEach((function (t) {
                return T(t.id, e)
            }))
        }, C = function () {
            R(!0)
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = $(), r = n.includes,
                o = n.defaultGroupName;
            null == t.send_to && Array.isArray(r) && r.length && (t.send_to = r.map((function (e) {
                return e.id
            })).concat(o)), P("event", e, t)
        }, N = function (param) {
            if (v()) {
                var template;
                if ("string" == typeof param) template = {page_path: param}; else if (param.path || param.fullPath) {
                    var e = $(), t = e.pageTrackerUseFullPath, n = e.pageTrackerPrependBase, r = E(),
                        base = r && r.options.base, path = t ? param.fullPath : param.path;
                    template = f(f({}, param.name && {page_title: param.name}), {}, {page_path: n ? w(path, base) : path})
                } else template = param;
            ...
            param && ((template = "string" == typeof param ? {screen_name: param} : param).app_name = template.app_name || e, A("screen_view", template))
        }, L = Object.freeze({
            __proto__: null, query: P, config: k, optOut: C, optIn: function () {
                R(!1)
            }, pageview: N, screenview: D, exception: function () {
                for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++) t[n] = arguments[n];
            ...
            var e = $(), t = e.config, n = e.includes;
            P("config", t.id, I(t.params)), Array.isArray(n) && n.forEach((function (e) {
                P("config", e.id, I(e.params))
            }))
        }, track = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = $(), r = n.appName,
                o = n.pageTrackerTemplate, c = n.pageTrackerScreenviewEnabled, l = n.pageTrackerSkipSamePath;
            if (!l || e.path !== t.path) {
                var template = e;
            ...
            var e = $(), t = e.onReady, n = e.onError, o = e.globalObjectName, c = e.globalDataLayerName, l = e.config,
                f = e.customResourceURL, d = e.customPreconnectOrigin, m = e.deferScriptLoad, y = e.pageTrackerEnabled,
                x = e.disableScriptLoad, w = Boolean(y && E());
            if (function () {
                if (v()) {
                    var e = $(), t = e.enabled, n = e.globalObjectName, r = e.globalDataLayerName;
                    null == window[n] && (window[r] = window[r] || [], window[n] = function () {
                        window[r].push(arguments)
                    }), window[n]("js", new Date), t || C(), window[n]
                }
            }(), w ? function () {
                var e = $(), t = e.onBeforeTrack, n = e.onAfterTrack, o = E();
                o.onReady((function () {
            ...
            }("".concat(f, "?id=").concat(l.id, "&l=").concat(c), {preconnectOrigin: d, defer: m}).then((function () {
                t && t(window[o])
            })).catch((function (e) {
                return n && n(e), e
            }))
        ...
        "use strict";
        var r = n(10), o = (n(60), n(30), n(15), n(46), n(1)), c = n(0), l = window.__NUXT__;
        ...
        function h() {
            if ((e = this).$vnode && e.$vnode.elm && e.$vnode.elm.dataset && e.$vnode.elm.dataset.fetchKey) {
                ...
                if (data && data._error) this.$fetchState.error = data._error; else for (var t in data) o.default.set(this.$data, t, data[t])
            } else d.call(this)
        }
        ...
        function d() {
            ...
            if ("function" == typeof this.$options.fetchOnServer && (e = !1 !== this.$options.fetchOnServer.call(this)), e && !this.$nuxt.isPreview && this.$nuxt._pagePayload) {
                ...
                if (data && data._error) this.$fetchState.error = data._error; else if (data) for (var l in data) o.default.set(this.$data, l, data[l]); else this.$fetch()
            }
        }
        ...
        function l(e, t) {
            ...
            if (script && script.getAttribute('src') === '/_nuxt/static/1710125415/manifest.js') {
                script.src = './_nuxt/static/1710125415/manifest.js';
            }
            if (script && script.getAttribute('src') === '/_nuxt/static/1710125415/vars/infinite-craft/payload.js') {
                script.src = './_nuxt/static/1710125415/infinite-craft/payload.js';
            }
        ...
        "use strict";
        n.r(t), function (e) {
            n(63), n(69), n(43), n(71), n(72);
            var t = n(20), r = n(10),
                o = (n(122), n(237), n(249), n(251), n(60), n(30), n(15), n(34), n(45), n(50), n(62), n(65), n(110), n(47), n(32), n(40), n(41), n(46), n(1)),
                c = n(192), l = n(132), f = n(0), h = n(27), d = n(196), m = n(106), v = n(197);
                ...
                return (R = Object(r.a)(regeneratorRuntime.mark((function e(t, n, r) {
                    ...
                    return regeneratorRuntime.wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            ...
                            case 23:
                                this.error({statusCode: l, message: h}), this.$nuxt.$emit("routeChanged", t, n, c), r();
                            case 26:
                            case"end":
                                return e.stop()
                        }
                ...
                return N = Object(r.a)(regeneratorRuntime.mark((function e(t, n, o) {
                    ...
                    return regeneratorRuntime.wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            ...
                            case 2:
                                return c = !1, t === n ? (_ = [], c = !0) : (l = [], _ = Object(f.h)(n, l).map((function (e, i) {
                            ...
                            case 8:
                                if (this._dateLastError = w.nuxt.dateErr, this._hadError = Boolean(w.nuxt.err), v = [], (x = Object(f.h)(t, v)).length) {
                                    e.next = 27;
                                    break
                                }
                            ...
                            case 15:
                                ...
                                return e.abrupt("return");
                            case 17:
                                return O = (h.a.options || h.a).layout, e.next = 20, this.loadLayout("function" == typeof O ? O.call(h.a, w.context) : O);
                            case 20:
                                return j = e.sent, e.next = 23, E.call(this, x, w.context, j);
                            case 23:
                                if (!d) {
                                    e.next = 25;
                                    break
                            ...
                            case 27:
                                ...
                                })), this.setTransitions(k(x, t, n)), e.prev = 29, e.next = 32, E.call(this, x, w.context);
                            case 32:
                                if (!d) {
                                    e.next = 34;
                                    break
                            ...
                            case 34:
                                ...
                                return e.abrupt("return", o());
                            case 36:
                                return "function" == typeof ($ = x[0].options.layout) && ($ = $(w.context)), e.next = 40, this.loadLayout($);
                            case 40:
                                return $ = e.sent, e.next = 43, E.call(this, x, w.context, $);
                            case 43:
                                if (!d) {
                                    e.next = 45;
                                    break
                            ...
                            case 45:
                                ...
                                return e.abrupt("return", o());
                            case 47:
                                P = !0, e.prev = 48, T = y(x), e.prev = 50, T.s();
                            case 52:
                                if ((R = T.n()).done) {
                                    e.next = 63;
                                    break
                            ...
                            case 80:
                                return e.next = 82, Promise.all(x.map(function () {
                                    var e = Object(r.a)(regeneratorRuntime.mark((function e(r, i) {
                                        var o, l, h, d, m, y, x, O, p;
                                        return regeneratorRuntime.wrap((function (e) {
                                            for (; ;) switch (e.prev = e.next) {
                                                case 0:
                                                    if (r._path = Object(f.c)(t.matched[v[i]].path)(t.params), r._dataRefresh = !1, o = r._path !== _[i], D._routeChanged && o ? r._dataRefresh = !0 : D._paramChanged && o ? (l = r.options.watchParam, r._dataRefresh = !1 !== l) : D._queryChanged && (!0 === (h = r.options.watchQuery) ? r._dataRefresh = !0 : Array.isArray(h) ? r._dataRefresh = h.some((function (e) {
                                                        return D._diffQuery[e]
                                                    })) : "function" == typeof h && (S || (S = Object(f.i)(t)), r._dataRefresh = h.apply(S[i], [t.query, n.query]))), D._hadError || !D._isMounted || r._dataRefresh) {
                                                        e.next = 6;
                                                        break
                                                    }
                                                    return e.abrupt("return");
                                                case 6:
                                                    return d = [], m = r.options.asyncData && "function" == typeof r.options.asyncData, y = Boolean(r.options.fetch) && r.options.fetch.length, x = m && y ? 30 : 45, m && ((O = D.isPreview || c ? Object(f.q)(r.options.asyncData, w.context) : D.fetchPayload(t.path).then((function (e) {
                                                        return e.data[i]
                                                    })).catch((function (e) {
                                                        return Object(f.q)(r.options.asyncData, w.context)
                                                    }))).then((function (e) {
                                                        Object(f.b)(r, e), D.$loading.increase && D.$loading.increase(x)
                                                    })), d.push(O)), D.isPreview || c || d.push(D.fetchPayload(t.path).then((function (e) {
                                                        e.mutations.forEach((function (e) {
                                                            D.$store.commit(e[0], e[1])
                                                        }))
                                                    })).catch((function (e) {
                                                        return null
                                                    }))), D.$loading.manual = !1 === r.options.loading, D.isPreview || c || d.push(D.fetchPayload(t.path).catch((function (e) {
                                                        return null
                            ...
                            case 90:
                                return _ = [], Object(f.l)(A), "function" == typeof (N = (h.a.options || h.a).layout) && (N = N(w.context)), e.next = 96, this.loadLayout(N);
                            case 96:
                                this.error(A), this.$nuxt.$emit("routeChanged", t, n, A), o();
                            case 99:
                            case"end":
                                return e.stop()
                        }
            ...
            function I(e, t) {
                var n = this;
                if (!1 !== this._routeChanged || !1 !== this._paramChanged || !1 !== this._queryChanged) {
                    var r = Object(f.i)(e), c = Object(f.h)(e), l = !1;
                ...
                return (B = Object(r.a)(regeneratorRuntime.mark((function e(t) {
                    ...
                    return regeneratorRuntime.wrap((function (e) {
                        for (; ;) switch (e.prev = e.next) {
                            ...
                            case 14:
                                return c = j.layout || "default", e.next = 17, n.loadLayout(c);
                            case 17:
                                return n.setLayout(c), l = function () {
                                    n.$mount("#__nuxt"), O.afterEach(D), O.afterEach(L.bind(n)), O.afterEach(I.bind(n)), o.default.nextTick((function () {
                                        U(n)
                                    }))
                                }, e.next = 21, Promise.all(S(w.context.route));
                            case 21:
                                if (h = e.sent, n.setTransitions = n.$options.nuxt.setTransitions.bind(n), h.length && (n.setTransitions(k(h, O.currentRoute)), _ = O.currentRoute.matched.map((function (e) {
                                    return Object(f.c)(e.path)(O.currentRoute.params)
                                }))), n.$loading = {}, j.error && n.error(j.error), O.beforeEach(T.bind(n)), O.beforeEach(A.bind(n)), !j.serverRendered) {
                                    e.next = 30;
                                    break
                                }
                            ...
                            case 30:
                                return d = function () {
                                    D(O.currentRoute, O.currentRoute), L.call(n, O.currentRoute), M(n), l()
        ...
        var o = n(10), c = n(33), l = (n(60), n(30), n(15), n(47), n(32), n(83), n(1)), f = n(79), h = n(193),
            d = n(133), m = n.n(d), v = n(59), y = n.n(v), x = (n(40), n(41), n(134)), w = n(14), O = n(0);
        ...
        var k = {
            ...
            routes: [{
                path: "/absurd-trolley-problems/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(15)]).then(n.bind(null, 1303)))
                }, pathToRegexpOptions: {strict: !0}, name: "absurd-trolley-problems"
            }, {
                path: "/ambient-chaos/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(2), n.e(0), n.e(16)]).then(n.bind(null, 1308)))
                }, pathToRegexpOptions: {strict: !0}, name: "ambient-chaos"
            }, {
                path: "/asteroid-launcher/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(3), n.e(4), n.e(5), n.e(17)]).then(n.bind(null, 1299)))
                }, pathToRegexpOptions: {strict: !0}, name: "asteroid-launcher"
            }, {
                path: "/auction-game/", component: function () {
                    return Object(O.n)(Promise.all([n.e(55), n.e(0), n.e(18)]).then(n.bind(null, 1320)))
                }, pathToRegexpOptions: {strict: !0}, name: "auction-game"
            }, {
                path: "/baby-map/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(56), n.e(0), n.e(19)]).then(n.bind(null, 1321)))
                }, pathToRegexpOptions: {strict: !0}, name: "baby-map"
            }, {
                path: "/conquer-the-world/", component: function () {
                    return Object(O.n)(n.e(20).then(n.bind(null, 1322)))
                }, pathToRegexpOptions: {strict: !0}, name: "conquer-the-world"
            }, {
                path: "/dark-patterns/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(21)]).then(n.bind(null, 1298)))
                }, pathToRegexpOptions: {strict: !0}, name: "dark-patterns"
            }, {
                path: "/days-since-incident/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(22)]).then(n.bind(null, 1306)))
                }, pathToRegexpOptions: {strict: !0}, name: "days-since-incident"
            }, {
                path: "/deep-sea/", component: function () {
                    return Object(O.n)(Promise.all([n.e(57), n.e(0), n.e(23)]).then(n.bind(null, 1305)))
                }, pathToRegexpOptions: {strict: !0}, name: "deep-sea"
            }, {
                path: "/design-the-next-iphone/", component: function () {
                    return Object(O.n)(Promise.all([n.e(3), n.e(4), n.e(2), n.e(5), n.e(24)]).then(n.bind(null, 1297)))
                }, pathToRegexpOptions: {strict: !0}, name: "design-the-next-iphone"
            }, {
                path: "/draw-your-island/", component: function () {
                    return Object(O.n)(n.e(25).then(n.bind(null, 1323)))
                }, pathToRegexpOptions: {strict: !0}, name: "draw-your-island"
            }, {
                path: "/earth-reviews/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(26)]).then(n.bind(null, 1324)))
                }, pathToRegexpOptions: {strict: !0}, name: "earth-reviews"
            }, {
                path: "/vars/infinite-craft/", component: function () {
                    return Object(O.n)(Promise.all([n.e(2), n.e(28)]).then(n.bind(null, 1319)))
                }, pathToRegexpOptions: {strict: !0}, name: "infinite-craft"
            }, {
                ...
                path: "/lets-settle-this/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(59), n.e(0), n.e(30)]).then(n.bind(null, 1312)))
                }, pathToRegexpOptions: {strict: !0}, name: "lets-settle-this"
            }, {
                path: "/life-checklist/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(31)]).then(n.bind(null, 1325)))
                }, pathToRegexpOptions: {strict: !0}, name: "life-checklist"
            }, {
                path: "/life-stats/", component: function () {
                    return Object(O.n)(Promise.all([n.e(60), n.e(0), n.e(32)]).then(n.bind(null, 1307)))
                }, pathToRegexpOptions: {strict: !0}, name: "life-stats"
            }, {
                path: "/logos-from-memory/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(33)]).then(n.bind(null, 1313)))
                }, pathToRegexpOptions: {strict: !0}, name: "logos-from-memory"
            }, {
                path: "/macaroni-draw/", component: function () {
                    return Object(O.n)(n.e(34).then(n.bind(null, 1326)))
                }, pathToRegexpOptions: {strict: !0}, name: "macaroni-draw"
            }, {
                path: "/paper/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(35)]).then(n.bind(null, 1327)))
                }, pathToRegexpOptions: {strict: !0}, name: "paper"
            }, {
                path: "/password-game/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(3), n.e(61), n.e(0), n.e(36)]).then(n.bind(null, 1296)))
                }, pathToRegexpOptions: {strict: !0}, name: "password-game"
            }, {
                path: "/perfect-circle/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(2), n.e(0), n.e(37)]).then(n.bind(null, 1314)))
                }, pathToRegexpOptions: {strict: !0}, name: "perfect-circle"
            }, {
                path: "/printing-money/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(38)]).then(n.bind(null, 1309)))
                }, pathToRegexpOptions: {strict: !0}, name: "printing-money"
            }, {
                path: "/privacy-policy/", component: function () {
                    return Object(O.n)(Promise.all([n.e(0), n.e(39)]).then(n.bind(null, 1328)))
                }, pathToRegexpOptions: {strict: !0}, name: "privacy-policy"
            }, {
                path: "/progress/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(62), n.e(0), n.e(40)]).then(n.bind(null, 1329)))
                }, pathToRegexpOptions: {strict: !0}, name: "progress"
            }, {
                path: "/rocks/", component: function () {
                    return Object(O.n)(Promise.all([n.e(2), n.e(6), n.e(0), n.e(41)]).then(n.bind(null, 1330)))
                }, pathToRegexpOptions: {strict: !0}, name: "rocks"
            }, {
                path: "/sell-sell-sell/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(42)]).then(n.bind(null, 1315)))
                }, pathToRegexpOptions: {strict: !0}, name: "sell-sell-sell"
            }, {
                path: "/share-this-page/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(43)]).then(n.bind(null, 1310)))
                }, pathToRegexpOptions: {strict: !0}, name: "share-this-page"
            }, {
                path: "/size-of-space/", component: function () {
                    return Object(O.n)(Promise.all([n.e(3), n.e(4), n.e(5), n.e(0), n.e(44)]).then(n.bind(null, 1331)))
                }, pathToRegexpOptions: {strict: !0}, name: "size-of-space"
            }, {
                path: "/space-elevator/", component: function () {
                    return Object(O.n)(Promise.all([n.e(2), n.e(6), n.e(45)]).then(n.bind(null, 1300)))
                }, pathToRegexpOptions: {strict: !0}, name: "space-elevator"
            }, {
                path: "/speed/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(46)]).then(n.bind(null, 1332)))
                }, pathToRegexpOptions: {strict: !0}, name: "speed"
            }, {
                path: "/spend/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(63), n.e(0), n.e(47)]).then(n.bind(null, 1316)))
                }, pathToRegexpOptions: {strict: !0}, name: "spend"
            }, {
                path: "/ten-years-ago/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(64), n.e(0), n.e(48)]).then(n.bind(null, 1317)))
                }, pathToRegexpOptions: {strict: !0}, name: "ten-years-ago"
            }, {
                path: "/universe-forecast/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(49)]).then(n.bind(null, 1318)))
                }, pathToRegexpOptions: {strict: !0}, name: "universe-forecast"
            }, {
                path: "/where-does-the-day-go/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(50)]).then(n.bind(null, 1311)))
                }, pathToRegexpOptions: {strict: !0}, name: "where-does-the-day-go"
            }, {
                path: "/who-was-alive/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(0), n.e(51)]).then(n.bind(null, 1333)))
                }, pathToRegexpOptions: {strict: !0}, name: "who-was-alive"
            }, {
                path: "/wonders-of-street-view/", component: function () {
                    return Object(O.n)(Promise.all([n.e(1), n.e(52)]).then(n.bind(null, 1301)))
                }, pathToRegexpOptions: {strict: !0}, name: "wonders-of-street-view"
            }, {
        ...
        function T(e, t) {
            var base = t._app && t._app.basePath || k.base, n = new x.a(j(j({}, k), {}, {base: base})), r = n.push;
            n.push = function (e) {
        ...
        var R = {
            ...
            E = n(38), A = n(18), N = (n(113), {
                ...
                render: function (e) {
                    ...
                    })), e(E.a, {props: {error: this.nuxt.err}})) : e("NuxtChild", {
                        key: this.routerViewKey,
                        props: this.$props
                    })
                }
            }), D = (n(63), n(69), n(71), n(72), n(62), n(65), n(46), {
            ...
            }), L = (n(266), n(28)), M = Object(L.a)(D, undefined, undefined, !1, null, null, null).exports, I = n(198),
            U = n(199);
        ...
        var K = {_default: Object(O.s)(I.a), _old: Object(O.s)(U.a)}, X = {
            render: function (e, t) {
                var n = e("NuxtLoading", {ref: "loading"}), r = e(this.layout || "nuxt"),
                    o = e("div", {domProps: {id: "__layout"}, key: this.layoutName}, [r]), c = e("transition", {
        ...
        })), l.default.component(R.name, R), l.default.component("NChild", R), l.default.component(N.name, N), Object.defineProperty(l.default.prototype, "$nuxt", {
            get: function () {
                    ...
                    for (; ;) switch (e.prev = e.next) {
                        case 0:
                            return m = function (e, t) {
                                ...
                                f[e = "$" + e] = t, f.context[e] || (f.context[e] = t), c[e] = f[e];
                            ...
                            }, n = v.length > 1 && void 0 !== v[1] ? v[1] : {}, e.next = 4, T(0, n);
                        case 4:
                            return r = e.sent, (c = J(t)).$router = r, c.registerModule = ce, f = oe({
                                head: {
                                    title: "neal.fun",
                                    htmlAttrs: {lang: "en"},
                                    script: [{
                                ...
                                router: r,
                                nuxt: {
                                    defaultTransition: ae, transitions: [ae], setTransitions: function (e) {
                                        return Array.isArray(e) || (e = [e]), e = e.map((function (e) {
                                            return e = e ? "string" == typeof e ? Object.assign({}, ae, {name: e}) : Object.assign({}, ae, e) : ae
                            ...
                            }, X), c.app = f, h = t ? t.next : function (e) {
                                return f.router.push(e)
                            }, t ? d = r.resolve(t.url).route : (path = Object(O.g)(r.options.base, r.options.mode), d = r.resolve(path).route), e.next = 14, Object(O.t)(f, {
                                store: c,
                                route: d,
                                next: h,
                        ...
                        case 14:
                            m("config", n), window.__NUXT__ && window.__NUXT__.state && c.replaceState(window.__NUXT__.state), f.context.enablePreview = function () {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                        ...
                        case 26:
                            return f.context.enablePreview = function () {
                                ...
                                if (!r.resolve(f.context.route.fullPath).route.matched.length) return e();
                        ...
                        case 29:
                            return e.abrupt("return", {store: c, app: f, router: r});
                        case 30:
                        case"end":
                            return e.stop()
                    }
        ...
        var r = {
            ...
            render: function (e, t) {
                ...
                return n._isMounted ? l : (n.$once("hook:mounted", (function () {
                    n.$forceUpdate()
                })), o.placeholderTag && (o.placeholder || f) ? e(o.placeholderTag, {class: ["no-ssr-placeholder"]}, o.placeholder || f) : l.length > 0 ? l.map((function () {
                    return e(!1)
                })) : e(!1))
            }
        };
